...
# Applying gradient style to the header
st.markdown('<h1 class="text-gradient">StockSim News Sentiment Analyzer</h1>', unsafe_allow_html=True)
...
st.header("StockSim News Sentiment Analyzer")
